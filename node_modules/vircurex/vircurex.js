  ...
  var req = https.request(options, function(res) {
    ...
    res.on('end', function() {
      try {
        ...
        callback(_this.createError(10000), null)
      }
    })
  })
 ...
 * @param {Function} callback(err, data)
 */
Vircurex.prototype.readOrder = function(orderId, orderType, callback) {
  this.apiCallWithToken(
    'read_order',
    this.keys.readOrder,
    [['orderid', orderId], ['otype', orderType]],
    callback
  )
}
 ...
 * @param {Function} callback(err, data)
 */
Vircurex.prototype.readOrders = function(orderType, callback) {
  this.apiCallWithToken(
    'read_orders',
