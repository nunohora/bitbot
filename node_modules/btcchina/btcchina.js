...
BTCChina.prototype.orderbook = function(params, callback) {
...
BTCChina.prototype.createOrder = function (type, market, currency, amount, callback) {
  this._tradeRequest(type + 'Order', [market, currency, amount], callback);
};
